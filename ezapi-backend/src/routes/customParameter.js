...
router.get('/customParameters/get/:projectID', authenticate, async (req, res) => {
	try {
...
router.post('/customParameters/add', authenticate, async (req, res) => {
	try {
...
router.patch('/customParameters/delete', authenticate, async (req, res) => {
	try {
...
// edit parameter
router.patch('/customParameters/edit', authenticate, async (req, res) => {
	try {
