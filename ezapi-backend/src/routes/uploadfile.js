...
router
	.route('/upload_file')
	.post(validateLinkedinToken, authenticate, upload.single('file'), fileController.parseFileData);

//router.post('/upload_file', validateLinkedinToken, authenticate, upload.single("file"), fileController.parseFileData);
