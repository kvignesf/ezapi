...
router.post(
	'/resources',
	authenticate,
	validator(requests.resourceAddRequest),
	async (req, res) => {
		try {
...
router.patch('/path/add', authenticate, validator(requests.addPathRequest), async (req, res) => {
...
router.patch(
	'/path/rename',
	authenticate,
	validator(requests.renamePathRequest),
	async (req, res) => {
		try {
			const resourceId = req.body.resourceId;
...
router.patch(
	'/path/delete',
	authenticate,
	validator(requests.deletePathRequest),
	async (req, res) => {
		try {
			const resourceId = req.body.resourceId;
			const pathId = req.body.pathId;
...
router.patch(
	'/operation/add',
	authenticate,
	validator(requests.addOperationRequest),
	async (req, res) => {
		try {
			const projectId = req.body.projectId;
			const resourceId = req.body.resourceId;
